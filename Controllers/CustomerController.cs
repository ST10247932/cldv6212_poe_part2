...
namespace ABCRetailApp.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> StoreCustomer(CustomerProfile customer)
        {
            ...
            var response = await _httpClient.PostAsync("https://st10247932cldvp2.azurewebsites.net/api/StoreCustomerProfile?code=QPrfUUuAQaMhoqniBv9qHJsiivJnetLApArz96Z-yQfrAzFuD0Eqqg%3D%3D", content);
