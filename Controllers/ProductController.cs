    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(Product product, IFormFile imageFile)
        {
            ...
            try
            {
                ...
                var response = await httpClient.PostAsync("https://st10247932cldvp2.azurewebsites.net/api/StoreProduct?code=QPrfUUuAQaMhoqniBv9qHJsiivJnetLApArz96Z-yQfrAzFuD0Eqqg%3D%3D", httpContent);
