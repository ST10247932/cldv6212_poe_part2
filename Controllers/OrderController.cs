        ...
        public async Task<IActionResult> Create()
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var response = await _httpClient.PostAsync("https://st10247932cldvp2.azurewebsites.net/api/orders/send?code=QPrfUUuAQaMhoqniBv9qHJsiivJnetLApArz96Z-yQfrAzFuD0Eqqg%3D%3D", content);
